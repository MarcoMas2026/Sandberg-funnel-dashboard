...
export const LIVE_BASELINES: Record<string, LiveBaseline> = {
  ...
  "32396": { since: SINCE, spend: 443.86, impressions: 17248, clicks: 1257, linkClicks: 856, form: { starts: 63, completions: 26 } },
  "32136": { since: SINCE, spend: 94.95, impressions: 4755, clicks: 354, linkClicks: 232 }, // Can Aura
  "32825": { since: SINCE, spend: 55.05, impressions: 1972, clicks: 142, linkClicks: 110 }, // Penthouse Olinto
  "32859": { since: SINCE, spend: 34.04, impressions: 1387, clicks: 88, linkClicks: 61 }, // Ses Salines
};
